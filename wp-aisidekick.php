...
function aisidekick_admin_footer($data)
{
    ...
    <div id="aisidekick" class="small">
      ...
      <div id="aisidekickmenu">
         <button onclick="toggleAiSidekickSize()" id="toggleAiSidekickSize"></button>
         <button onclick="toggleAiSidekick()" id="toggleAiSidekick"></button>
       </div>
       </div>
      <iframe
